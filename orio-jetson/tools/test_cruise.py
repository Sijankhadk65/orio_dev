...
def test_escape_duty() -> None:
    ...
    # Boxed in, the policy stops to look around once before it pivots. That
    # look is the body's job and is covered elsewhere; this is about the duty
    # the pivot gets when it comes.
    av.scan = False
