...
# ///
"""
Live WASD teleop for bench-testing the drivetrain.
...
Windows-only -- uses msvcrt for non-blocking keyboard polling.

Usage:
    pip install pyserial
    python tools/teleop_wasd.py COM5
"""
import sys
import time

if sys.platform != "win32":
    print("This script uses msvcrt for keyboard input and only runs on Windows.")
    sys.exit(1)
